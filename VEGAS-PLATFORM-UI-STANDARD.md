...
| Categoria | Exemplos | Cores (fundo / texto) |
|---|---|---|
...
1. Lista com filtros e ação Novo.
2. Formulário ou detalhe com seções claras.
3. Confirmação de exclusão ou inativação.
4. Histórico quando a entidade for operacional ou auditável.

### 22.2 Analítica

1. Filtros de período e escopo.
2. KPIs.
3. Gráficos.
4. Tabela detalhada.
5. Exportação e definição de última atualização.

### 22.3 Operacional

1. Fila priorizada.
2. Contexto e responsável.
3. Ação principal visível.
4. SLA ou tempo decorrido.
5. Linha do tempo e evidências.
