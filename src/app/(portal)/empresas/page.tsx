...
const PRODUTOS = ['Alimentação','Vegas Plus','Vegas Day','Aux. Combustível','Combustível Frota','Farmácia','Plus Bank','Plus Híbrido','Vegas Benefícios','Alimentação Híbrido','Cartão Natal']
