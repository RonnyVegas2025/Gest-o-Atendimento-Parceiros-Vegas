...
const NEXT_STATUSES: Record<string, { value: string; label: string }[]> = {
  aberto: [
    { value: 'em_analise', label: 'Iniciar analise' },
  ],
  em_analise: [
  ...
  cancelado:  [],
  rascunho: [
    { value: 'aberto', label: 'Abrir atendimento' },
  ],
}
...
export default function TicketDetailPage() {
  ...
  async function fetchData() {
    ...
    setLoading(false)
    if (t) setActionDept((t as any).department)
  }
    ...
    <div className="p-6">
      <div className="flex items-center gap-3 mb-5 flex-wrap">
        ...
        <span className="flex items-center gap-1.5 text-xs text-gray-600">
          ...
          {ticket.priority === 'alta' ? 'Alta' : ticket.priority === 'media' ? 'Media' : 'Baixa'}
        </span>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="grid grid-cols-2 gap-x-8 gap-y-4 mb-5">
                ...
                <div><div className="text-xs text-gray-400 mb-0.5">Tipo</div><div className="text-sm font-medium text-gray-900">{ticket.type}</div></div>
                <div><div className="text-xs text-gray-400 mb-0.5">Departamento atual</div><div className="text-sm font-medium text-gray-900">{currentDeptLabel}</div></div>
                ...
                <div><div className="text-xs text-gray-400 mb-0.5">Responsavel</div><div className="text-sm font-medium text-gray-900">{ticket.assigned_to_name ?? '—'}</div></div>
                <div><div className="text-xs text-gray-400 mb-0.5">Aberto por</div><div className="text-sm font-medium text-gray-900">{ticket.created_by_name}</div></div>
              </div>
              <div>
            ...
            <div className="card-body">
              ...
              <div className="border-t border-gray-100 pt-4">
                ...
                <PasteTextarea
                  value={obsText}
                  onChange={setObsText}
                  placeholder="Descreva uma atualizacao — use Ctrl+V para colar prints..."
                  rows={2}
                />
        ...
        <div className="space-y-4">
                ...
                <>
                  ...
                  {actionStatus && (
                    <PasteTextarea
                      ...
                      placeholder="Observacao sobre esta acao (opcional)..."
                      rows={2}
                    />
                  )}
                  ...
                  {actionStatus && (
                    <button onClick={handleAction} disabled={saving} className="btn-primary w-full justify-center">
                      ...
                      {saving ? 'Salvando...' : 'Confirmar acao'}
                    </button>
                  )}
          ...
          <div className="card">
            ...
            <div className="card-body space-y-2">
              ...
              <div className="flex justify-between text-xs"><span className="text-gray-400">Cidade</span><span className="font-medium text-gray-700">{ticket.company_city}/{ticket.company_state}</span></div>
