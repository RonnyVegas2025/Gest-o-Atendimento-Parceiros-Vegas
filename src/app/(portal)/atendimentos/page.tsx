      ...
      <div className="card overflow-hidden">
        ...
        {loading ? (
          ...
          <Link key={ticket.id} href={`/atendimentos/${ticket.id}`}
            ...
            <span className="text-xs text-gray-500 self-center">{DEPARTMENT_LABELS[ticket.department] ?? ticket.department}</span>
        ...
        <div className="card opacity-70">
          ...
          {closed.map(ticket => (
            <Link key={ticket.id} href={`/atendimentos/${ticket.id}`}
              ...
              <span className="text-xs text-gray-400 self-center">{DEPARTMENT_LABELS[ticket.department] ?? ticket.department}</span>
